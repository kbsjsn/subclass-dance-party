describe('chameleonDancer', function() {
    ...
    beforeEach(function() {
      ...
      chameleonDancer = new ChameleonDancer(10, 20, timeBetweenSteps);
    });
    ...
    it('should have a step function that makes its node slide', function() {
      sinon.spy(chameleonDancer.$node, 'animate');
      chameleonDancer.step();
      expect(chameleonDancer.$node.animate.called).to.be.true;
    });
